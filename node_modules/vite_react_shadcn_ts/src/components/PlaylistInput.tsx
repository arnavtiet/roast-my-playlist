...
import { RoastLevel } from "./RoastIntensitySlider";

interface PlaylistInputProps {
  onSubmit: (url: string, level: RoastLevel) => void;
  isLoading?: boolean;
  roastLevel: RoastLevel;
}

export const PlaylistInput = ({ onSubmit, isLoading, roastLevel }: PlaylistInputProps) => {
